...
namespace MidDb26_2025CS127.UI.Froms
{
    public partial class AddProjectForm : Form
    {
        ...
        private ComboBox advisorRoleComboBox;
        private List<Advisor> advisors = new List<Advisor>();
        private List<Lookup> advisorRoles = new List<Lookup>();
        ...
        public AddProjectForm(Project project, string headerText, string btnText)
        {
            ...
            SelectAdvisor(project.AdvisorId);
            SelectAdvisorRole(project.AdvisorRoleId);
        }
